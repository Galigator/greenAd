...
The 'hosts' file tell your computer what is the IP address (a technical stuff) that match the human readable form the address bar you can see in your browser (Edge/Firefox/Chrome ...). 
...
The way I have web site into 'hosts' make you computer resolve the bad site as beeing your own computer; but your computer isn't a web server.
...
# How have you choose the web site you are blocking ?
...
I am developper, I watch network connections, and read things that look technical for you but obvious for me.
...
# I have use you list and now my internet doesn't work, this is your fault.
